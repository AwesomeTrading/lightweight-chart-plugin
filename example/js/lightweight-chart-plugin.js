...
class LighweightChartPlugin{
    ...
    addRectangle(time1, price1, time2, price2, color = 'rgba(0, 0, 255, 0.5)', useGradient = false, tooltipText = '', triggered = true) {
        this.rectangles.push({ time1:this.set_date(time1), price1, time2:this.set_date(time2), price2, color, useGradient, tooltipText, triggered });
        // this.onMouseWheelEnd();
    }
    redrawRectangles() {
